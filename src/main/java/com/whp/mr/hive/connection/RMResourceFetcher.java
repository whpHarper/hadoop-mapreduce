 ...
 *
 */
package com.whp.mr.hive.connection;

import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.whp.mr.hive.HiveJobFetch;
import com.whp.mr.hive.HiveQLParserContent;
import com.whp.mr.hive.Parser;
import com.whp.mr.hive.model.AppInfo;
import com.whp.mr.hive.model.AppsWrapper;
import com.whp.mr.hive.model.ClusterInfoWrapper;
import com.whp.mr.hive.utils.*;
...
public class RMResourceFetcher implements ResourceFetcher<AppInfo> {
    ...
    public RMResourceFetcher(String clusterUrl,String historyUrl) {
//        this.selector = new HAURLSelectorImpl(rmBasePaths, Constants.CompressionType.NONE);
    ...
    public String getRunningJobURL(Constants.JobType jobType, String startTime, String endTime, String limit) {
        ...
        String url = URLUtil.removeTrailingSlash(clusterUrl);
    ...
    private String getAcceptedAppURL(Object... parameter) {
        ...
        String baseUrl = URLUtil.removeTrailingSlash(clusterUrl);
...
//        selector.checkUrl();
    ...
    private String getClusterInfoURL() {
        return clusterUrl + "/" + Constants.YARN_API_CLUSTER_INFO + "?" + Constants.ANONYMOUS_PARAMETER;
    }
